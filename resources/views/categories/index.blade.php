    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div id="content" class="container">
                <div class="row" id="content" style="display: flex; justify-content: center">
                    @foreach ($categories as $category)
                        ...
                        <div class="modal fade" id="{{ $category->name }}" tabindex="-1" role="dialog"
                             aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" style="text-transform: uppercase"
                                            id="exampleModalLongTitle">{{ $category->name }}</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <img class="p-2 card-img-top"
                                             style="border-radius: 20px; border: 0.5px silver solid; width: 250px; height: 250px"
                                             src="/images/{{ $category->image }}" alt="">
                                        <div class="p-2"
                                             style="border-radius: 3px;">{!! $category->description  !!}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
